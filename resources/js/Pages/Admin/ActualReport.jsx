    ...
    const buildIndicators = (type) => {
        ...
        filteredReports.forEach((report) => {
            ...
            indicators.forEach((item) => {
                ...
                const actualValue = number(item.actual);

                row.values[month] += actualValue;
    ...
    */
    ...
    const manHourMetrics = useMemo(() => {
        ...
        filteredReports.forEach((report) => {
            ...
            rowKmPremises.values[month] += number(
            ...
            >
                ...
                >
                    <div>
                        ...
                        >
                            Report Actual HSE satu tahun penuh dengan Quarter 1
                            sampai Quarter 4.
                        </p>
                    </div>
                ...
                >
                    Menampilkan <strong>ACTUAL</strong> tahun {year}. Data
                    dibagi berdasarkan Januari–Desember dan Quarter 1–4.
                </div>
                ...
                {renderTable("LAGGING INDICATOR - ACTUAL", [
                    ...lagging,
                    ...manHourMetrics,
                ])}

                {renderTable("LEADING INDICATOR - ACTUAL", leading)}
            </main>
        </div>
    );
}
